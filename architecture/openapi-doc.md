        ...
        "responses": {
          "200": {
            ...
            "content": {
              "text/plain": {
                "schema": {
                  "$ref": "#/components/schemas/CreatedAtActionResult"
                }
              },
              "application/json": {
                "schema": {
    ...
    "schemas": {
      ...
      "BindingInfo": {
        ...
        "properties": {
          ...
          "requestPredicate": {
            "$ref": "#/components/schemas/ActionContextBooleanFunc"
          },
          "emptyBodyBehavior": {
            "$ref": "#/components/schemas/EmptyBodyBehavior"
          },
          "serviceKey": {
            "nullable": true
          }
      ...
      "IPropertyFilterProvider": {
        ...
        "properties": {
          "propertyFilter": {
            "$ref": "#/components/schemas/ModelMetadataBooleanFunc"
          }
        },
        "additionalProperties": false
      },
